...
public class Exercise8Fragment extends BaseFragment implements ComputeFactorialUseCase.Listener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_exercise8, container, false);
    ...
    private int getTimeout() {
        ...
        if(mEdtTimeout.getText().toString().isEmpty()) {
            ...
            timeout = Integer.valueOf(mEdtArgument.getText().toString());
    ...
    public void onFactorialTimedOut() {
        mBtnStartWork.setEnabled(true);
        mTxtResult.setText("Computation Timeout!");
    }
